...
$$(document).on("page:init", '.page[data-name="dashboard"]', function(e) {
  ...
  if (!datalogin && !user) {
    ...
    function onCapturePhoto(fileURI) {
      ...
      ft.upload(
        fileURI,
        encodeURI("https://api.harnic.id/courier/uploadBukti/"),
        win,
        fail,
        options
      );
...
$$(document).on("page:init", '.page[data-name="cod"]', function(e) {
  ...
  $$("#send_otp").click(function() {
    var post_data = {
      kurir_nama: user.kurir_nama,
      trx_val: total_selected,
      trx_change: total_change
    };
        ...
        if (d.count > 0) {
          ...
          d.trx.forEach(el => {
            ...
            <label class="item-checkbox item-content">\
              <input type="checkbox" name="trx" value="' +
                el.salesid +
                '" net="' +
                el.net +
                '" kembali="' +
              ...
              <div class="item-inner">\
                ...
                el.customer +
                '/Jakarta Utara</div>\
                <div class="item-text">Rp.' +
                parseInt(el.net).toLocaleString("en") +
                "<br/>Kembalian: Rp." +
                parseInt(el.kembali).toLocaleString("en") +
                "</div>\
              </div>\
            </label>\
          </li>"
